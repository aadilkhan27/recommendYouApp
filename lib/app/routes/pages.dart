...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
        name: Routes.signUpStepOne,
        page: () => StepOneView(),
        binding: StepOneBinding()),
    GetPage(
        name: Routes.signUpStepTwo,
        page: () => StepTwoView(),
        binding: StepTwoBinding()),
    GetPage(
        name: Routes.signUpStepThree,
        page: () => StepThreeView(),
        binding: StepThreeBinding()),
    GetPage(
        name: Routes.signUpStepFour,
        page: () => StepFourView(),
    ...
    GetPage(
        name: Routes.resetUsername,
        page: () => RetrieveUsername(),
        binding: RetrieveUsernameBinding()),
    GetPage(
        name: Routes.otpVerify,
        page: () => OtpVerificationView(),
        binding: OtpVerficationBinding()),
    GetPage(
        name: Routes.otpVerifyUsername,
        page: () => VerifyOtpUsernameView(),
        binding: VerifyOtpUserNameBinding()),
    GetPage(
    ...
    GetPage(
        ...
        page: () => SearchPeopleView(),
        binding: SearchPeopleBinding()),
    GetPage(
        name: Routes.changeContact,
        page: () => ChangeContactView(),
        binding: ChangeContactBinding()),
    GetPage(
    ...
    GetPage(
        name: Routes.likes, page: () => LikesView(), binding: LikesBinding()),
    GetPage(
